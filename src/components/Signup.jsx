		...
		<div className="p-10 bg-[#e5e8f0]">
          ...
          {/* <span className='text-xs text-gray-400 font-bold absolute right-0 top-0'>Not a member? <span className='text-blue-500'>Register now</span></span> */}
					<div className='text-center '>
						<h1 className="font-semibold text-black text-3xl my-2"> Create Account!</h1>
            <p className='text-gray-400  mb-5'>Welcome! Join our community today.</p>
...
<input type="email" id="email" name="email" required /> */}
              ...
              {/* <div className='text-blue-500 w-60 text-xs font-bold text-end mb-5'>forgot password?</div> */}
							...
							<button
								className={`text-white bg-orange-500 w-60 p-2 mt-3 rounded-lg shadow-3xl shadow-orange-500 ${isSubmitting ?  "blur-sm" : ""}`}								type="submit"
